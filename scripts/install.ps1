# install.ps1 — one-line installer for alcove (Windows)
# Usage: irm https://github.com/epicsagas/alcove/releases/latest/download/install.ps1 | iex
param(
...
$tmpdir  = New-Item -ItemType Directory -Path (Join-Path $env:TEMP "alcove-install-$pid") -Force
