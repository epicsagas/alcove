...
> Veja todos os modelos suportados em [EMBEDDING_MODELS.md](../docs/EMBEDDING_MODELS.md). Qualquer modelo pode ser configurado diretamente no arquivo de configuração.
