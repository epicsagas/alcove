...
> Veja todos os modelos suportados em [fastembed-rs](https://github.com/Anush008/fastembed-rs#supported-models). Qualquer modelo pode ser configurado diretamente no arquivo de configuração.
