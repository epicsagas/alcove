...
> Tous les modèles supportés sur [EMBEDDING_MODELS.md](../docs/EMBEDDING_MODELS.md). N'importe quel modèle peut être configuré directement dans le fichier de configuration.
