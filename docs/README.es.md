...
- **Funciona con más de 9 agentes** — Claude Code, Cursor, Claude Desktop, Cline, OpenCode, Codex, Copilot, Antigravity, Antigravity
...
6. Qué agentes de IA configurar (MCP + archivos de habilidades)
