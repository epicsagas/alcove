...
alcove bench        Бенчмарк качества поиска (точность, задержка, обнаружение регрессий)
...
Измеряйте и отслеживайте качество поиска с помощью встроенных IR-метрик и обнаружения регрессий.

```bash
# Запустить бенчмарк точности (10 категорий, 50 запросов)
