...
> Все поддерживаемые модели на [fastembed-rs](https://github.com/Anush008/fastembed-rs#supported-models). Любую модель можно настроить напрямую в файле конфигурации.
