...
> [fastembed-rs](https://github.com/Anush008/fastembed-rs#supported-models) पर सभी समर्थित मॉडल देखें। कोई भी मॉडल सीधे कॉन्फ़िग में सेट करके उपयोग किया जा सकता है।
