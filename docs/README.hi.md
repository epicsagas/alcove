...
5. **HTTP सर्वर** — होस्ट, पोर्ट, ऑटो-जनरेटेड बेयरर टोकन, और लॉगिन आइटम रजिस्ट्रेशन
...
| `index_code_structure` | tree-sitter से सोर्स कोड पार्स करके प्रति-प्रोजेक्ट `CODE_INDEX.md` जनरेट करें (`code-index` फीचर आवश्यक) |
...
alcove index-code   सोर्स कोड से कोड संरचना इंडेक्स जनरेट करें (code-index फीचर आवश्यक)
alcove token        टीम शेयरिंग के लिए बेयरर टोकन प्रिंट करें
...
alcove api <CMD>      बैकग्राउंड REST API सर्वर लाइफसाइकिल प्रबंधित करें (start, stop, status, enable, disable)
