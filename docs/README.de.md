...
Installiert automatisch das Skill und startet den API-Server. Sofort verfügbar — keine weiteren Schritte erforderlich.

Aktualisierungen mit `codex plugin update alcove@epicsagas`.
